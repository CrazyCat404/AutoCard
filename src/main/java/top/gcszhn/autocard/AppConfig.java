    ...
    public void setEnvironment(Environment env) {
        try {
            ...
            if (username != null && password != null && !username.isEmpty() && !password.isEmpty()) {
                ...
                LogUtils.printMessage(System.getenv("AUTOCARD_DELAY").toLowerCase());
                global_user.put("delay", System.getenv("AUTOCARD_DELAY") != null && System.getenv("AUTOCARD_DELAY").toLowerCase() != "true" && System.getenv("AUTOCARD_DELAY").toLowerCase() != "1");
